...
THIS PACKAGE CONTAINS THE INTERFACES THAT COMPRISE THE COMMON API GOVERNING
INTER-COMPUTER INTERACTIONS.   ALL INTER-COMPUTER INTERACTIONS MUST BE SPECIFIED 
