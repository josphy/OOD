...
public class BallModel {
	...
	public BallModel(IModel2ViewAdapter model2ViewAdpt) {
		...
		_updateTimeSlice = 25;
		_paintTimeSlice = 25;
		_updateTimer = new Timer(_updateTimeSlice, (e) -> 
		...
		_paintTimer = new Timer(_paintTimeSlice, (e) -> _model2ViewAdpt.update());
	}
...
//		myDispatcher.notifyAll(g); // The Graphics object is being given to all the sprites (Observers)
	 ...
	 * @param paintStrategy The paintStrategy for painting the ball
	 */
	...
	public IStrategyFac makeStrategyFac(final String className) {
		...
		return new IStrategyFac() {
			 ...
			 */
			public IUpdateStrategy make() {
				return loadStrategy("model.strategy." + className + "Strategy");
			}
	...
	*/
	...
	/**
	 * Load a paint strategy from strategy name
	 * almost the same as load strategy
	 * @param pntName Name of the paint strategy
	 * @return Paint strategy object
	 */
	...
	/**
	 * Make a paint strategy factory from the name string
	 * @param pntName Name of the paint strategy
