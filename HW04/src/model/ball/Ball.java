...
public class Ball implements Observer {
	 ...
	 * @param paintStrategy The paint strategy for painting the ball
	 */
	...
	/**
	 * set the current canvas panel
	 * @param canvas - current canvas to work on
	 */
	...
	/**
	 * get current paint strategy
	 * @return ball's current paint strategy
	 */
	...
	/**
	 * set current paint strategy and call initialization of paint strategy interface
	 * @param paintStrategy - desired paint strategy
	 */
