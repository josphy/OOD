...
The GUI can create 6 different types of balls, and dynamically combine any strategies. 
The balls can have 11 paint strategies to choose from. The animation of balls are shown 
in the ball panel.


1. Steps to run the BallWorld GUI:
	0) Open the project with eclipse, and click on the green "Run" button.
...
3. Paint Strategy Types:
	None Affine Transform based paint strategies:
	1) Ball
	2) Square
	...
	3. Ellipse
	4. Rectangle
	5. Fish1 : A polygon, looks like a fish with open mouth and long tail
	6. Fish2 : A polygon, looks like a fish with shut mouth and short tail
...
5. UML diagram and Javadocs
	UML diagrams are in file paint.umlcd and shape.umlcd . 
	The MVC part is not significantly changed, so we didn't create a diagram for MVC.
	Some classes in paintStrategy package and shape package are also omitted, because they're less representative.
	Javadocs are in HW04/doc folder.
