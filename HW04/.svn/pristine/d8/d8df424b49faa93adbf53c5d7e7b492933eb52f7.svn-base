 ...
 * Copied from https://www.clear.rice.edu/comp504/f17/lectures/lec12/
 */ 
public class EllipsePaintStrategy extends ShapePaintStrategy {
   ...
   * @param x - floating point x-coordinate of center of ellipse
   * @param y - floating point y-coordinate of center of ellipse
   * @param width - floating point x-radius of the ellipse
   * @param height - floating point y-radius of the ellipse
   */
  ...
  public EllipsePaintStrategy(AffineTransform at, double x, double y, double width, double height){
	  super(at, EllipseShapeFactory.getFac().makeShape(x, y, width, height));
  }
}
