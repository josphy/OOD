...
public class KeySignature {
	...
	private KeyNote[] notes = { new KeyNote('A', 0), new KeyNote('A', 1), new KeyNote('B', 0), new KeyNote('C', 0),
	...
	private KeyNote[] fs_dsm = { new KeyNote('A', 1), new KeyNote('B', 0), new KeyNote('C', 1), new KeyNote('D', 1),
	...
	* Utility class to keep track of the position of notes */
	private class KeyNote {
		...
		* Constructor for the class
		...
		/*package*/ KeyNote(char letter, int accidental) {
			this.letter = letter;
