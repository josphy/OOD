...
import provided.music.DecoratorSeqList;
import java.util.Stack;
import provided.token.ATokVisitor;
...
public class ABCParser {
	...
	/*package*/ double grace_multiplier = 0.2;
	/*package*/ double graceDuration = 0.0;
	private double dottedCorrection = 0.0;
	private ATokVisitor checkNextNoteAlgo = new ATokVisitor(new ITokVisitorCmd() {
		@Override
		public Object apply(String id, Token host, Object... params) {
	...
	* 
	...
	public IPhrase parse() {
		ISeqList beginning = (ISeqList) abcT.getNextToken().execute(makeSeqListAlgo, MTSeqList.Singleton);
